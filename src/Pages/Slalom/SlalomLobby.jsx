...
export default function SlalomLobby({ onRoomReady }) {
  ...
  return (
    <main className="min-h-screen bg-[#060610] text-white flex flex-col items-center justify-center px-4">
      <div className="w-full max-w-sm space-y-8">
        ...
        >
          <p>
            One skater, two players. <span style={{ color: "rgba(100,180,255,0.8)" }}>Player 1</span> controls
            the top skate (A / D). <span style={{ color: "rgba(255,80,100,0.8)" }}>Player 2</span> controls
            the bottom skate (← / →).
          </p>
          <p>
            Carve through slalom gates together and collect gems. Miss 3 gates and the run ends.
            Spread too far apart and you wipeout.
          </p>
        </div>
