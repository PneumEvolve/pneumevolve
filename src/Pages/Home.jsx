...
const TOOLS = [
  ...
  // Life
  {
    id: "habit-grid",
    title: "Habit Grid",
    desc: "A monthly grid for habits and goals. Color in your days, break long goals into stages, and watch the pattern build.",
    to: "/habit-grid",
    tags: ["habits", "goals", "tracking"],
    category: "life",
    isPublic: true,
    isFeatured: true,
    updatedAtISO: "2026-06-21",
    requiresAuth: true,
    isNew: true,
  },
  {
  ...
  // Games
  {
    id: "rootwork",
    title: "RootWork",
    desc: "An idle farming town builder. Plant, craft, sell, upgrade. Keeps running while you're away.",
    to: "/rootwork",
    tags: ["1 player", "idle", "mobile-friendly"],
    category: "games",
    isPublic: true,
    isFeatured: false,
  ...
  },
  {
    id: "firefly",
    title: "Firefly",
    desc: "One player runs around blind, the other directs them. Co-op trust game — works best on a phone call.",
    to: "/firefly",
    tags: ["2 player co-op", "desktop", "phone call required"],
    category: "games",
    isPublic: true,
    isFeatured: false,
  ...
  },
  {
    id: "slalom",
    title: "Slalom",
    desc: "A dumb simple arcade game. Each player controls a skate weaving down the slalom course.",
    to: "/slalom",
    tags: ["1-2 player", "arcade", "desktop or mobile"],
    category: "games",
    isPublic: true,
    isFeatured: false,
    updatedAtISO: "2026-05-01",
  ...
  },
  {
    id: "stronghold",
    title: "Stronghold",
    desc: "Wave defense for two — one builds, one protects. Hold the line together.",
    to: "/stronghold",
    tags: ["2 player", "wave defense", "desktop preferred"],
    category: "games",
    isPublic: true,
    isFeatured: false,
    updatedAtISO: "2026-05-01",
  ...
  },
  {
    id: "dead-miles",
    title: "Dead Miles",
    desc: "Drive around, run over zombies, collect loot. Two-player chaos on four wheels.",
    to: "/dead-miles",
    tags: ["2 player", "zombies", "desktop"],
    category: "games",
    isPublic: true,
    isFeatured: false,
    updatedAtISO: "2026-05-01",
  ...
  },
  {
    id: "zombase",
    title: "ZomBase",
    desc: "Build up your base, survive the waves, find the cure to win. Solo zombie defense.",
    to: "/zombase",
    tags: ["1 player", "wave defense", "desktop preferred"],
    category: "games",
    isPublic: true,
    isFeatured: false,
    updatedAtISO: "2026-05-01",
  ...
  },
  {
    id: "inkrun",
    title: "InkRun",
    desc: "One player runs, the other draws the path. A two-player game of trust and improvisation.",
    to: "/inkrun",
    tags: ["2 player", "desktop preferred"],
    category: "games",
    isPublic: true,
    isFeatured: false,
    updatedAtISO: "2026-05-01",
  ...
  },
  {
    id: "homestead",
    title: "Homestead",
    desc: "Build a town, go on runs for loot, build it bigger. Play solo or with a friend.",
    to: "/homestead",
    tags: ["1-2 player", "town builder", "desktop preferred"],
    category: "games",
    isPublic: true,
    isFeatured: false,
    updatedAtISO: "2026-05-01",
...
const CATEGORIES = [
  ...
  },
  {
    id: "games",
    label: "Games",
    desc: "Arcade stuff. Built to mess around in.",
    icon: "🎮",
  },
];
