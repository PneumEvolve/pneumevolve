    ...
    <main className="p-6 max-w-4xl mx-auto space-y-12 text-center">
      ...
      <section>
        ...
        <p className="mt-4 text-lg">
          Tired of shouting into the void? <span className="font-semibold">Enter the Forge</span> —
          a place to post problems and ideas, vote on what matters, and turn momentum into action.
        </p>

        {/* Two primary actions */}
        <div className="mt-6 flex items-center justify-center gap-3 flex-wrap">
          <Link to="/forge2" className="btn">
            Browse and Vote in the Forge
          </Link>
      ...
      <section>
        ...
        {!loading && loadErr && (
          <p className="text-sm opacity-70">{loadErr}</p>
        )}
